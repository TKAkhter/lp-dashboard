...
<div class="d-sm-flex align-items-center justify-content-between mb-4 flex-sm-column flex-lg-row flex-md-column w-100">
        <h1 class="h3 custom-secondary mb-0">Profile</h1>
    ...
    <div class="col-lg-3 col-md-3 col-sm-3 px-4 profile-mobile">
        <img src="../img/undraw_profile.svg" class="img-fluid" src="Logo" alt="Logo">
    </div>
    <script>
