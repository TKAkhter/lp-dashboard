...
<!-- Content Wrapper -->
<div id="content-wrapper" class="custom-bg-light d-flex flex-column">

    <!-- Main Content -->
    <div id="content">

        <!-- Topbar -->
        <nav class="navbar navbar-expand navbar-light custom-bg-dark topbar mb-4 static-top shadow nav-desktop">
            ...
            <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                <div class="input-group">
                    <button class="btn custom-primary btn-lg" type="button" id="button-addon1">
                        <i class="fas fa-search fa-sm"></i>
                    </button>
                    <input type="text" class="form-control border-0 small custom-bg-dark custom-light" placeholder="Search for..." aria-label="Search" aria-describedby="basic-addon1">
                </div>
            </form>
        ...
        <div class="navbar navbar-expand navbar-light custom-bg-dark topbar mb-4 static-top shadow nav-mobile d-sm-none d-md-none d-lg-none">
            <ul class="navbar-nav ml-auto">
